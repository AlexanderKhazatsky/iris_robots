...
scene_changes = [
	...
	'Move the camera poses slightly (pertubation)',
	'Move the camera poses significantly (entirely new angle)',
...
camera_page_instr = {
 ...
 # 'Compositional Tasks':
	# ['Open a container (ex: pot, drawer), and put an object in. Or vice versa.',
	#  'Pour something into a bowl, then stir it.',

	#  'Fold, spread out, or clump an object (ex: cloth, clothes)',
	# ]